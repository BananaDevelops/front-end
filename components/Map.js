      ...
      <table className="bg-green w-11/12">
        <tbody>
          ...
          if (mapTile === 2) {
            ...
            return <td key={idxB} className="bg-black"><Image src="/static/img/player.png" alt="playericon" width="50" height="50"/></td>
          }
          // 3 is monster
          if (mapTile === 3) {
            color = "w-1 p-5 bg-black"
          ...
          // 4 is item space
          if (mapTile === 4) {
            return <td key={idxB} className="bg-black"><Image src="/static/img/sword.png" alt="swordicon" width="50" height="50"/></td>
          }          
